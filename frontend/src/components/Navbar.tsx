...
<button className="md:hidden p-2 hover:bg-white/20 rounded-lg" onClick={() => setMenuOpen(!menuOpen)}>
...
<NavLink href="/history">History</NavLink>
<ToggleButton />
<button onClick={logout} className="btn-ghost text-left">Logout</button>
</div>
</div>
)}
</header>
